...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers("/api/user/login","api/user/logout","/api/user/{email}/email","/api/passenger","/api/user/{id}/resetPassword", "/api/image/**", "/api/vehicleType").permitAll().
